...
function movePoint(e) {
  ...
  let xcoordinate =
    target.value * (document.getElementById("finalx").value - 3);
...
document.getElementById("finalx").onchange = function () {
  ...
  let new_position =
    3 + (dot_list[0].position.x * (new_value - 3)) / (final_xcoordinate - 3);
  dot_list[0].position.set(
    new_position - 3,
...
document.getElementById("finaly").onchange = function () {
  ...
  let new_position =
    3 + (dot_list[0].position.y * (new_value - 3)) / (final_ycoordinate - 3);
  dot_list[0].position.set(
...
document.getElementById("finalz").onchange = function () {
  ...
  let new_position =
    3 + (dot_list[0].position.z * (new_value - 3)) / (final_zcoordinate - 3);
  dot_list[0].position.set(
    dot_list[0].position.x,
    dot_list[0].position.y,
    new_position - 3
...
document.getElementById("frames").onchange = function () {
  ...
  let new_xcoord =
    3 + parseFloat((dot_list[0].position.x * frames) / new_value);
  let new_ycoord =
    3 + parseFloat((dot_list[0].position.y * frames) / new_value);
  let new_zcoord =
    3 + parseFloat((dot_list[0].position.z * frames) / new_value);
  console.log(frames, new_value);
  console.log(new_xcoord, new_ycoord, new_zcoord);
  dot_list[0].position.set(new_xcoord - 3, new_ycoord - 3, new_zcoord - 3);
